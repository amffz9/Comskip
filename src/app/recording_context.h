...
struct RecordingState {
    ...
    comskip::platform::FilePtr videoredo3_file;
    comskip::platform::FilePtr btv_file;
    ...
    comskip::platform::FilePtr edlx_file;
    comskip::platform::FilePtr cuttermaran_file;
    ...
    comskip::platform::FilePtr dvrmstb_file;
